...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "yzs132-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/eebhub2"
  #   chef.validation_client_name = "eebhub2-validator"
  #   chef.validation_key_path = ".chef/eebhub2-validator.pem"
  # end
end
